	...
	{                                                                           \
		do {                                                                \
			...
			if ((ik->type == LIBIPCON_EVENT_PEER_ADD)) {                \
				ipcon_dbg(                                          \
					"%s- %d LIBIPCON_EVENT_PEER_ADD %s\n",      \
					__func__, __LINE__, ik->peer.name);         \
				break;                                              \
			}                                                           \
                                                                                    \
			if ((ik->type == LIBIPCON_EVENT_PEER_REMOVE)) {             \
				ipcon_dbg(                                          \
					"%s- %d LIBIPCON_EVENT_PEER_REMOVE %s\n",   \
					__func__, __LINE__, ik->peer.name);         \
				break;                                              \
			}                                                           \
                                                                                    \
			if ((ik->type == LIBIPCON_EVENT_GRP_ADD)) {                 \
				ipcon_dbg(                                          \
					"%s- %d LIBIPCON_EVENT_GRP_ADD %s.%s\n",    \
					__func__, __LINE__,                         \
			...
			if ((ik->type == LIBIPCON_EVENT_GRP_REMOVE)) {              \
				ipcon_dbg(                                          \
					"%s- %d LIBIPCON_EVENT_GRP_REMOVE %s.%s\n", \
					__func__, __LINE__,                         \
					ik->group.peer_name, ik->group.name);       \
				break;                                              \
			}                                                           \
